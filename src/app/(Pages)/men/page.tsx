    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-20 pb-6 border-b md:px-16 bg-gray-50">
        <p className="mt-5 text-sm text-gray-500">
          Home / Collections /{" "}
          <span className="font-semibold text-black">Men&apos;s Wear</span>
        </p>
        <div className="flex items-center justify-between mt-3">
          <h1 className="text-4xl font-bold md:text-5xl">Men&apos;s Wear</h1>
           <input
              type="text"
              id="search-navbar"
              placeholder="Men Product Search..."
              className="block w-1/4 p-2 text-sm text-black border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
            />
      ...
      <div className="grid gap-6 px-6 py-10 md:grid-cols-4 md:px-16">
        ...
        {/* Product Grid */}
{/* Product Grid */}
<section className="grid grid-cols-2 gap-8 md:col-span-3 lg:grid-cols-3 xl:grid-cols-4">
  {products.map((product, index) => (
    <motion.div
      ...
      className="relative transition-shadow duration-300 bg-white shadow-md cursor-pointer group rounded-xl hover:shadow-xl"
    ...
    >
      ...
      <div className="relative w-full aspect-[3/4] overflow-hidden rounded-t-xl">
        <Image
          src={hoveredProduct === product.id ? product.image1 : product.image}
          alt={product.title}
          fill
      ...
      <AnimatePresence>
        {hoveredProduct === product.id && (
          ...
          >
            {/* You can add popup content here later */}
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
